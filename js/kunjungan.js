...
async function bukaRekamMedisHariIni(kId) {
    ...
    // calculateIMT(), checkTensi(), checkLabAlert() dipanggil dari hook
...
function openModal(idx, dataObj) {
    ...
    const labHasilItems = []; // semua hasil lab kini dari req_lab
...
// ════════════════════════════════════════════════════════
//  EDIT LOCK, SIMPAN REKAM MEDIS & FLOATING SAVE BUTTON
//  → Dipindahkan ke pemeriksaan-medis.js
//    karena semua DOM yang dioperasikan milik page-medis.html.
// ════════════════════════════════════════════════════════
